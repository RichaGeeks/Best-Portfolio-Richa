...
const Quotes = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center w-full h-[230px] bg-#121111 shadow-lg">
        <div className="flex w-[92vw] h-[200px]">
          {/* Feature 1 */}
          <div
            className={`relative min-w-[60px] overflow-hidden m-2 border bg-[#F4511E] bg-cover bg-center rounded-[50px] shadow-md cursor-pointer transition-all duration-100 ease-in-out ${
              activeIndex === 0
          ...
          {/* Feature 2 */}
          <div
            className={`relative min-w-[60px] overflow-hidden m-2 border bg-[#7659EA] bg-cover bg-center rounded-[50px] shadow-md cursor-pointer transition-all duration-100 ease-in-out ${
              activeIndex === 1
                ? "flex-grow-[10] bg-[auto_100%]"
                : "flex-grow bg-[auto_150%]"
            }`}
          ...
          {/* Feature 3 */}
          <div
            className={`relative min-w-[60px] overflow-hidden m-2 border bg-[#F4F4F4] bg-cover bg-center rounded-[50px] shadow-md cursor-pointer transition-all duration-100 ease-in-out ${
              activeIndex === 2
                ? "flex-grow-[10] bg-[auto_100%]"
                : "flex-grow bg-[auto_150%]"
            }`}
          ...
          {/* Feature 4 */}
          <div
            className={`relative min-w-[60px] overflow-hidden m-2 border bg-[#7cfce3] bg-cover bg-center rounded-[50px] shadow-md cursor-pointer transition-all duration-100 ease-in-out ${
              activeIndex === 3
                ? "flex-grow-[10] bg-[auto_100%]"
                : "flex-grow bg-[auto_150%]"
            }`}
